  ...
  return (
    <div style={{ perspective: '900px' }}>
      <motion.div
        ...
        className={cn(
          'group relative flex flex-col overflow-hidden rounded-xl p-6 glass',
          href && 'cursor-pointer',
          className,
        )}
        variants={{
      ...
      >
        ...
        <motion.div
          ...
          style={{ color: 'rgba(26,138,113,0.8)' }}
          variants={{
        ...
        {href && (
          <div className="relative mt-4 pt-1" onClick={(e) => e.stopPropagation()}>
